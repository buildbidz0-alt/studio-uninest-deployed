      ...
      <div className="space-y-12">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
          ...
          <section>
            ...
            <p>
              UniNest provides a marketplace for students and vendors to buy and sell goods. All payments are processed through Stripe, and you agree to comply with Stripe's terms of service. UniNest is not a party to any transaction and is not responsible for the quality, safety, or legality of items sold. Refund policies are determined by the individual vendors, and UniNest is not responsible for mediating disputes.
            </p>
          </section>
