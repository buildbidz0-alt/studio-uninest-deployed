    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className={cn("w-[--sidebar-width] p-0 [&>button]:hidden", finalClassName)}
          style={
            {
        ...
        <div className={cn('transition-opacity duration-200', state === 'expanded' ? 'opacity-0 w-0' : 'opacity-100 w-auto')}>
             <Link href="/" className="flex items-center gap-2">
                <div className="p-2 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg">
                    <svg className="size-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12.67 19a1 1 0 0 0-1.34 0l-5.03 5.03-1.3-1.3 5.03-5.03a1 1 0 0 0 0-1.34l-5.03-5.03 1.3-1.3 5.03 5.03a1 1 0 0 0 1.34 0l5.03-5.03 1.3 1.3-5.03 5.03a1 1 0 0 0 0 1.34l5.03 5.03-1.3 1.3z" /><path d="M12 19l-5.03 5.03" /><path d="M12.67 19l5.03 5.03" /><path d="M12 7V1" /><path d="M10 3h4" /></svg>
                </div>
            </Link>
        </div>
    </div>
